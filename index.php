...
if ($unlocked) {
    ...
    $data = [
        ...
        ["name" => "Diego", "message" => "Hey Schwöschterherz<br>Ich wünsche dir ganz schöni Wiehnachte und han dich ganz fest gern!❤️ bin immer für dich da!😘", "color1" => "#96c8eb", "color2" => "#96d8eb", "color3" => "#96b8eb"],
